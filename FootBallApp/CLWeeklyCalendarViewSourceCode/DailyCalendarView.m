...
{
        self.dateLabelContainer.backgroundColor = (blnSelected)?[UIColor colorWithHex:0x8CC739]: [UIColor clearColor];
        self.dateLabel.textColor = (blnSelected)?[UIColor whiteColor]:[self colorByDate];
    
}
-(UIColor *)colorByDate
{
    return [self.date isPastDate]?[UIColor colorWithHex:0x000000]:[UIColor blackColor];
}
