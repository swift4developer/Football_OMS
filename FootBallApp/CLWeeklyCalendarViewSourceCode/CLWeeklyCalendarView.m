...
-(void)applyCustomDefaults
{
    ...
    self.selectedDatePrintColor = attributes[CLCalendarSelectedDatePrintColor]? attributes[CLCalendarSelectedDatePrintColor] : [UIColor blackColor];
...
-(void)delegateSwipeAnimation: (BOOL)blnSwipeRight blnToday: (BOOL)blnToday selectedDate:(NSDate *)selectedDate
{
    ...
    if(selectedDate){
        ...
        NSLog(@"Todays date is %@", selectedDate);
    }
